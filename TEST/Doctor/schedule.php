     ...
     <table class="menu-container" border="0">
             ...
             <tr class="menu-row" >
                 <td class="menu-btn menu-icon-session menu-active menu-icon-session-active">
                     <a href="schedule.php" class="non-style-link-menu non-style-link-menu-active"><img src="../img/session.png" height=50></a>
                 </td>
             </tr>
             <tr class="menu-row" >
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        ...
                                        <a href="?action=view&id='.$scheduleid.'" class="non-style-link"><img src="../img/view.jpg" height=30></a>
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=drop&id='.$scheduleid.'&name='.$title.'" class="non-style-link"><img src="../img/cancel.png" height=30></a>
                                        </div>
                                        </td>
                                    </tr>';
